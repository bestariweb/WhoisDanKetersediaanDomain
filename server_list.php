...
$servers['co.id']['address'] = "whois.pandi.or.id";
$servers['co.id']['free'] = "DOMAIN NOT FOUND";
$servers['co.id']['param'] = "";

$servers['ac.id']['address'] = "whois.pandi.or.id";
$servers['ac.id']['free'] = "DOMAIN NOT FOUND";
$servers['ac.id']['param'] = "";

$servers['sch.id']['address'] = "whois.pandi.or.id";
$servers['sch.id']['free'] = "DOMAIN NOT FOUND";
$servers['sch.id']['param'] = "";

$servers['web.id']['address'] = "whois.pandi.or.id";
$servers['web.id']['free'] = "DOMAIN NOT FOUND";
$servers['web.id']['param'] = "";
